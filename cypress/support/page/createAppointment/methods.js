...
class CreateAppointment {
    ...
    addDate(days, price) {
        cy.get('.datetimepicker > [dir="ltr"] > .dp-input-container > .dp-picker-input').click();
    ...
    validate() {
        ...
        cy.get(el.tableField).contains('Lucilene Test New Client').should('be.visible')
    }
    validateOverlapAppointment() {
        cy.contains('You already have another appointment booked at the selected time. Are you sure you want to proceed with booking this appointment').should('be.visible')
    }
